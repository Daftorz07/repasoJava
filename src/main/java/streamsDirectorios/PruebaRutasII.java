...
public class PruebaRutasII {
    ...
    public static void main(String[] args) {
        ...
        String rutaPrincipal = "src" + File.separator + "archivos" + File.separator + "streamsDirectorios" + File.separator + nuevaRuta;
...
class EliminarArchivo {
    ...
    public void eliminarArchivo(String rutaArchivo, String nombreArchivo) {
        ...
        String rutaArchivoEliminar = "src" + File.separator + "archivos" + File.separator + "streamsDirectorios" + File.separator + rutaArchivo + File.separator + nombreArchivo;
